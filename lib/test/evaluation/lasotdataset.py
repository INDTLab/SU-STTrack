...
class LaSOTDataset(BaseDataset):
    ...
    def get_init_data(self, sequence_name):
        sequence = self._construct_sequence(sequence_name)
        print("sequence.init_data",sequence.init_data)
        return sequence.init_data
    ...
    def _construct_sequence(self, sequence_name):
        ...
        nlp_file = open(nlp_path, 'r', encoding='UTF-8')
        
        nlp = nlp_file.read()
        #print("nlp in lasotdataset.py",nlp)
        #init_data['caption'] = nlp
