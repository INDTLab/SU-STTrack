...
def draw_success_precision(success_ret, name, videos, attr, precision_ret=None,
    ...
    if attr == 'ALL':
        plt.title('Success plots of OPE on %s' % (name), weight='bold')
    else:
        plt.title('Success plots of OPE - %s' % (attr), weight='bold')    
    plt.axis([0, 1]+axis)
    success = {}
    ...
    if precision_ret:
        ...
        #modified by xuelin
        if attr == 'ALL':
            plt.title('Precision plots of OPE on %s' % (name), weight='bold')
        else:
            plt.title('Precision plots of OPE - %s' % (attr), weight='bold')
        plt.axis([0, 50]+axis)
        precision = {}
    ...
    if norm_precision_ret:
        ...
        #modified by xuelin
        if attr == 'ALL':
            plt.title('Normalized Precision plots of OPE on %s' % (name), weight='bold')
        else:
            plt.title('Normalized Precision plots of OPE - %s' % (attr), weight='bold')
        norm_precision = {}
